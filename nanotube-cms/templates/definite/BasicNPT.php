...
/**
 * Template with one-site-per-page layout and predefined (and predimplemented) methods for putting header, site header, footer, etc. Theese methods can be simply overriden to provide custom functionality.
 * */
class BasicNPT extends NormalPageTemplate {
